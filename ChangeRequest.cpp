/*
    ...
    changerequest.cpp:
    This file contains the implementations of the ChangeRequest class methods.
    It includes necessary headers and implements classes and functions to interact with the database.
    The purpose of this file is to provide a concrete implementation of the ChangeRequest class operations, ensuring that
    the main logic of the application remains separate from the database-specific code. This design promotes 
    cohesion by grouping all ChangeRequest-related functionality together.
*/
//-------------------------------------
// List of #includes
...
ChangeRequest::ChangeRequest(const char* changeID, const char* requesterName) {
    ...
    this->changeID[5] = '\0'; // Ensure null termination
